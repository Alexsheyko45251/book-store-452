   	...
   	<form action="cart.php" method="post">
	   	<table class="table">
	   		<tr>
	  			...
	  			<th>Кількість</th>
	   			<th>Сумарна ціна</th>
                <th>Кількість товару в наявності</th>
	   		</tr>
	   		<?php
		    	foreach($_SESSION['cart'] as $isbn => $qty){
					$conn = db_connect();
	   	...
	   	<input type="submit" class="btn btn-primary" name="save_change" value="Зберегти до корзини">
	</form>
	<br/><br/>
	<a href="checkout.php" class="btn btn-primary">Оформити замовлення</a>
	<a href="books.php" class="btn btn-primary">Продовжити покупки</a>
<?php
	} else {
