...
$sql = "SELECT orderid, ship_name, total_price, ship_address, date, ship_city, ship_zip_code, ship_country FROM orders WHERE date = '$date'";
...
<br>
   <h1 class='text-center'> Перелік замовників за  $date </h1> <?php 
<br>
