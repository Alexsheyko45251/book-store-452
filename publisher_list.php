<?php
	...
	if(mysqli_num_rows($result) == 0){
		echo "Пусте видавництво! Щось не так! перевірити ще раз ";
		exit;
	}
...
?>
    <img class="img-responsive img-thumbnail" src="./bootstrap/img/author.jpg"  align="right" width="150" height="100">
	<h1 class="lead">Автори книг: </h1>
	...
	<?php } ?>
		<li>
			<a href="books.php">Переглянути каталог книг</a>
		</li>
	</ul>
<?php
	mysqli_close($conn);
