<?php
	...
	if(isset($_GET['pubid'])){
		...
		echo "Неправильний запит! Перевірте ще раз! ";
		exit;
	}
	...
	if(mysqli_num_rows($result) == 0){
		echo "На данний момент книг цього автора немає в наявності, скоро вони з'являться в наявності";
		exit;
	}
...
?>
	<p class="lead"><a href="publisher_list.php">Книги</a> > <?php echo $pubName; ?></p>
...
?>
	<div class="row">
		...
		<div class="col-md-7">
			...
			<a href="book.php?bookisbn=<?php echo $row['book_isbn'];?>" class="btn btn-primary">Детальніше</a>
		</div>
	</div>
	<br>
<?php
