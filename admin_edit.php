...
?>
	<form method="post" action="edit_book.php" enctype="multipart/form-data">
		...
		<input type="submit" name="save_change" value="Прийняти" class="btn btn-primary">
		<input type="reset" value="Відміна" class="btn btn-default">
	</form>
	<br/>
	<a href="admin_book.php" class="btn btn-success">Перейти далі</a>
<?php
